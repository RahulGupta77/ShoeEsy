  ...
  return (
    ...
    >
      <div className="h-[50%] mt-28 w-1/3 mr-10 flex flex-col gap-6 pl-7 pt-10 rounded-2xl p-4 bg-white shadow-[rgba(50,50,93,0.25)_0px_6px_12px_-2px,_rgba(0,0,0,0.3)_0px_3px_7px_-3px]">
        ...
        />
        <button className="bg-[#e4344c] hover:bg-[#bb283c] my-2  px-4 py-2 rounded-lg text-white font-semibold tracking-wider uppercase w-11/12 shadow-[4.0px_4.0px_4.0px_rgba(0,0,0,0.38)]">
          {/* <svg
            ariaHidden="true"
            role="status"
            className="inline w-5 h-5 me-3 text-[#bb283c] animate-spin"
            viewBox="0 0 100 101"
            fill="none"
