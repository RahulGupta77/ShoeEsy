...
const Header = () => {
  return (
    <div className='shadow-lg h-20 bg-slate-50 flex items-center px-5 gap-x-40'>
        ...
        <div className='w-2/5 border-2 h-1/2 border-gray-300 rounded-lg bg-white focus-within:border-gray-500 flex overflow-hidden'>
          <input className='w-11/12 h-full px-3 focus:outline-none' placeholder='Search with Ease...'/>
          <div className='w-1/12 bg-gray-200 p-1 cursor-pointer hover:bg-gray-300'>
            <img src="./search-icon.png" alt='search-icon' className='h-full w-full object-contain'/>
          </div>
        </div>
    </div>
  )
