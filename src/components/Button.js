...
const Button = ({ text, route, needArrow, arrowDirection }) => {
  return (
    <Link to={route}>
      <div className="rounded px-4 py-2 overflow-hidden group bg-[#de354c] relative hover:bg-gradient-to-r hover:from-red-600 hover:to-red-500 text-white hover:ring-2 hover:ring-offset-2 hover:ring-red-500 transition-all ease-out duration-300">
